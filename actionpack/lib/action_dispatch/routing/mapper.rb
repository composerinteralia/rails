...
module ActionDispatch
  module Routing
    class Mapper
      ...
      cattr_accessor :backtrace_cleaner, instance_accessor: false
        ...
        private
          ...
          def route_source_location
            if Mapper.route_source_locations
              ad_dir = File.expand_path("..", __dir__)
              caller_location = caller_locations.find { |cl| !cl.path.include?(ad_dir) }
